      ...
      body: SafeArea(
        child: Container(
          ...
          child: SingleChildScrollView(
            padding: EdgeInsets.only(bottom: 40), // for keyboard spacing
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("ROWS: ", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    SizedBox(
                      width: 50,
                      child: TextField(
                    ...
                    SizedBox(width: 20),
                    Text("COLUMNS: ", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    SizedBox(
                      width: 50,
                      child: TextField(
